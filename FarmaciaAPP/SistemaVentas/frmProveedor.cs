    ...
    public partial class frmProveedor : Form
    {
        ...
        private void CargarDatos()
        {
            ...
            if (oListaProveedor.Count > 0)
            {
                ...
                tablaProveedor.Columns.Add("RFC", typeof(string));
                ...
                {
                    tablaProveedor.Rows.Add(row.IdProveedor, row.RFC, row.RazonSocial, row.Telefono, row.Correo, row.Direccion, row.Activo == true ? "Activo" : "No Activo", row.Activo);
                }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            if (dgvProveedor.SelectedRows.Count > 0)
            {
                ...
                Proveedor oProveedor = new Proveedor()
                {
                    ...
                    RFC = Convert.ToString(dgvProveedor.Rows[index].Cells["RFC"].Value),
