...
namespace SistemaVentas
{
    public partial class frmRegistrarCompra : Form
    {
        ...
        private void frmRegistrarCompra_Load(object sender, EventArgs e)
        {
            ...
            dgvDetalleCompra.Columns.Add("RFC Proveedor", "RFC Proveedor");
            dgvDetalleCompra.Columns.Add("IdTienda", "IdTienda");
            dgvDetalleCompra.Columns.Add("RFC Tienda", "RFC Tienda");
        ...
        private void btnBuscarProveedor_Click(object sender, EventArgs e)
        {
            ...
            if(oObjecto != null)
            {
                ...
                if (oProveedor != null)
                {
                    ...
                    txtRFCProveedor.Text = oProveedor.RFC;
        ...
        {
            if(txtIdTienda.Text.Trim() == "0" && txtRFCTienda.Text.Trim() == "" || txtNombreTienda.Text.Trim() == "")
            {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if (!existeRegistro)
            {
                ...
                row.Cells["RFC Proveedor"].Value = txtRFCProveedor.Text.Trim();
                row.Cells["IdTienda"].Value = txtIdTienda.Text.Trim();
                row.Cells["RFC Tienda"].Value = txtRFCTienda.Text.Trim();
